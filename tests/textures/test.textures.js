  ...
  describe('lookup id', () => {
    ...
    describe('previously removed texture source', () => {
      it('should reuse newer texture source with new lookup id', () => {
        ...
        chai.assert(item.texture.source._activeTextureCount === 0, 'Active count of texture source should be 0');
        ...
        chai.assert(newItem.texture.source._activeTextureCount === 1, 'Active count of new texture source should be 1');
        ...
        chai.assert(newItem.texture.source._activeTextureCount === 2, 'Active count of new texture source should be 2');
