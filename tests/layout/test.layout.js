...
const FlexContainer = lng.FlexContainer;

const createMainSizeAspect = function(name = 'mainSize', select) {
  return FlexHtmlTester.createAspect(
    name,
    function(structure) {
      const getSize = size => {
...
const addSimpleStructureTests = (name, structure) => {
  describe('structure:' + name, () => {
    FlexHtmlTester.addMochaTestsFromAspects(
      'wrap',
      structure,
      [
    ...
    FlexHtmlTester.addMochaTestsFromAspects(
      ...
      [
        FlexHtmlTester.createAspectFromFlexProperty('direction', ['row', 'row-reverse', 'column', 'column-reverse']),
        FlexHtmlTester.createAspectFromFlexProperty('wrap', [true, false]),
        FlexHtmlTester.createAspectFromFlexProperty('justifyContent', [
          'flex-start',
          'flex-end',
          'center',
          'space-between',
    ...
    FlexHtmlTester.addMochaTestsFromAspects(
      ...
      [
        ...
        FlexHtmlTester.createAspectFromFlexProperty('alignContent', [
          'flex-start',
          'flex-end',
          'center',
          'space-between',
