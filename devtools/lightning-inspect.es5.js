(function(factory) {
    ...
    window.attachInspector = function(_ref) {
        const Element = _ref.Element,
            ...
            Stage = _ref.Stage,
            ElementTexturizer = _ref.ElementTexturizer,
        ...
        Element.prototype.dhtml = function() {
            ...
            if (this.stage.root === this && !this.dhtml_root) {
                ...
                const self = this;
                setTimeout(function() {
                    const bcr = self.stage.getCanvas().getBoundingClientRect();
        ...
        const oElement = Element;
        const oSetParent = oElement.prototype._setParent;
        ...
        Element.prototype._setParent = function(parent) {
            ...
            if (!window.mutatingChildren) {
                if (parent) {
                    const index = parent._children.getIndex(this);
        ...
        const oInit = Stage.prototype.init;

        Stage.prototype.init = function() {
            oInit.apply(this, arguments); // Apply stage scaling.

            this.root.core.updateDebugTransforms();
        };

        const oAddTag = oElement.prototype.addTag;
        ...
        const oRemoveTag = oElement.prototype.removeTag;
        ...
        const val = function val(c, n, v, dv) {
            if (c._element) {
                c = c._element;
            }
        ...
        var checkColors = function checkColors(elementRenderer) {
            const element = elementRenderer._element;
        ...
        const updateTextureAttribs = function updateTextureAttribs(element) {
            const _this2 = this;
            ...
            if (element.texture) {
                ...
                keys.forEach(
                    function(key) {
                        ...
                        val(element, "texture-".concat(f), nonDefaults[key], false);
                    }.bind(this)
                );
            }
        };
